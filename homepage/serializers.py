...
class HomepageSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'title', 'slug', 'bio_title', 'bio_paragraph1', 'bio_paragraph2', 'contact_email',
                  'contact_instagram', 'contact_facebook', 'contact_linkedin']
        depth = 1
...
class AboutSerializer(serializers.ModelSerializer):
    ...
    linkedin = homepage.contact_linkedin
    ...
    contact_linkedin = serializers.CharField(default=linkedin)

    class Meta:
        model = About
        fields = ['title', 'bio_image', 'body', 'contact_email', 'contact_instagram',
                  'contact_facebook', 'contact_linkedin']
        depth = 1
